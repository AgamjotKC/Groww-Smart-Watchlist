...
public class NseMarketDataProvider {
    ...
    public static class NseQuoteCache {
        ...
        public NseQuoteCache(String symbol, String companyName, double currentPrice, double prevClose,
                             double openPrice, double deltaPercent, long volume, double week52High,
                             double week52Low, List<Double> candlePrices, List<Long> candleVolumes,
        ...
        try {
            ...
            if (response.statusCode() == 200 && response.body() != null) {
                ...
                if (resultNode.isArray() && !resultNode.isEmpty()) {
                    ...
                    double openPrice = candlePrices.isEmpty() ? prevClose : candlePrices.get(0);

                    if (currentPrice > 0) {
                        NseQuoteCache quote = new NseQuoteCache(cleanSymbol, companyName, currentPrice, prevClose,
                                openPrice, deltaPercent, volume, week52High, week52Low, candlePrices, candleVolumes, false);
